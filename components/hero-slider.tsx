    ...
    <div className="relative h-[89vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-between px-4">
        <Button
          variant="ghost"
          size="icon"
          className="z-10 h-12 w-12 rounded-full bg-white/10 backdrop-blur-sm  transition-all hover:bg-indigo-600"
          onClick={prevSlide}
        >
        ...
        <div className="absolute inset-0 flex items-center justify-end px-8 md:px-16">
          <div className="max-w-xl text-right">
            ...
            <Button
              size="lg"
              className="border-2 border-indigo-600 hover:bg-white hover:text-indigo-600 bg-indigo-600 text-white transition-all duration-300 animate-fadeIn"
            >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="z-10 h-12 w-12 rounded-full bg-white/10 backdrop-blur-sm hover:bg-indigo-600 transition-all"
          onClick={nextSlide}
        >
