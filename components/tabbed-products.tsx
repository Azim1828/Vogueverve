...
export function TabbedProducts() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      switch (activeTab) {
        case "bestSellers":
          params.append("category", "womens-shoes");
          break;
        case "newArrivals":
          params.append("category", "mens-shirts");
          break;
        case "topRated":
          params.append("category", "mens-shoes");
          break;
      }
      ...
      <div className="mb-8 flex justify-center gap-8 border-b">
        {[
          ...
          <button
            ...
            className={cn(
              "relative pb-4 text-sm font-medium transition-colors hover:text-indigo-600",
              {
